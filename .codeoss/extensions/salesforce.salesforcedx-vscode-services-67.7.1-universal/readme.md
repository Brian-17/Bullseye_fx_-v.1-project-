...
- Observability (`src/observability`) — OpenTelemetry spans, App Insights, O11y. See [observability README](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/src/observability/README.md)
...
Please see the [contributing guide](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/../../CONTRIBUTING.md) for details on how to contribute to this project.

## License

[BSD 3-Clause License](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/LICENSE.txt)

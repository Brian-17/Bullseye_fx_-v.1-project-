...
exports.hardwareBreakpoint = exports.defaultAdapter = exports.debugServerPort = exports.gdbServerPath = exports.gdbPath = exports.skipMake = exports.gdbNonStop = exports.gdbAsync = exports.isRemoteTest = exports.openGdbConsole = exports.testProgramsDir = void 0;
...
const getGdbVersion_1 = require("../util/getGdbVersion");
const compareVersions_1 = require("../util/compareVersions");
function getScopes(dc_1) {
    return __awaiter(this, arguments, void 0, function* (dc, threadIndex = 0, stackIndex = 0) {
        // threads
...
function fillDefaults(test, argsIn) {
    ...
    (_a = args.verbose) !== null && _a !== void 0 ? _a : (args.verbose = true);
    (_b = args.logFile) !== null && _b !== void 0 ? _b : (args.logFile = logFileName(test));
    (_c = args.gdb) !== null && _c !== void 0 ? _c : (args.gdb = exports.gdbPath);
    (_d = args.openGdbConsole) !== null && _d !== void 0 ? _d : (args.openGdbConsole = exports.openGdbConsole);
    (_e = args.gdbAsync) !== null && _e !== void 0 ? _e : (args.gdbAsync = exports.gdbAsync);
    (_f = args.gdbNonStop) !== null && _f !== void 0 ? _f : (args.gdbNonStop = exports.gdbNonStop);
    (_g = args.hardwareBreakpoint) !== null && _g !== void 0 ? _g : (args.hardwareBreakpoint = exports.hardwareBreakpoint);
    return args;
}
...
function gdbVersionAtLeast(targetVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        return ((0, compareVersions_1.compareVersions)(yield (0, getGdbVersion_1.getGdbVersion)(exports.gdbPath || 'gdb'), targetVersion) >=
            0);
    });
}
/**

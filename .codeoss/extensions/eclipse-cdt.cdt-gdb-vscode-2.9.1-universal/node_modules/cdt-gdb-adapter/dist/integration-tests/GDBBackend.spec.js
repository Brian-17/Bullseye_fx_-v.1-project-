...
const GDBFileSystemProcessManager_1 = require("../desktop/processManagers/GDBFileSystemProcessManager");
describe('GDB Backend Test Suite', function () {
    let gdb;
    beforeEach(function () {
        return __awaiter(this, void 0, void 0, function* () {
            gdb = new GDBBackend_1.GDBBackend(new GDBFileSystemProcessManager_1.GDBFileSystemProcessManager());
            const args = {
                program: 'foo',
            };

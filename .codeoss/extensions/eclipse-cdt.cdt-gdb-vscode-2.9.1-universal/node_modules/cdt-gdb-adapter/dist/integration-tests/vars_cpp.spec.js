...
describe('Variables CPP Test Suite', function () {
    ...
    it('can read and set a cpp object variable', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(vars2.body.variables.length, 'There is a different number of variables than expected').to.equal(numVars);
    ...
    it('can evaluate anonymous and deeply nested structs and unions', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const vars = yield dc.variablesRequest({ variablesReference: vr });
            (0, chai_1.expect)(vars.body.variables.length, 'There is a different number of variables than expected').to.equal(numVars);
            (0, utils_1.verifyVariable)(vars.body.variables[3], 'n', 'Nest', '{...}', {
                hasChildren: true,
            });
            ...
            const structure = yield expandRecursively(vars.body.variables[3].variablesReference);

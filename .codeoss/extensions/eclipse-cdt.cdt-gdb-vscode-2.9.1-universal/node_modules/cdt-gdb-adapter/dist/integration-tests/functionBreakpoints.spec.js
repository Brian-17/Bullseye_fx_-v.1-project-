...
describe('function breakpoints', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        it('empty function breakpoint request if no breakpoint exists', () => __awaiter(this, void 0, void 0, function* () {
            const bpResp = yield dc.setFunctionBreakpointsRequest({
                breakpoints: [],
            });
            (0, chai_1.expect)(bpResp.body.breakpoints.length).eq(0);
        }));
        it('empty function breakpoint request if a breakpoint exists', () => __awaiter(this, void 0, void 0, function* () {
            yield dc.setFunctionBreakpointsRequest({
                breakpoints: [
                    {
                        name: 'main',

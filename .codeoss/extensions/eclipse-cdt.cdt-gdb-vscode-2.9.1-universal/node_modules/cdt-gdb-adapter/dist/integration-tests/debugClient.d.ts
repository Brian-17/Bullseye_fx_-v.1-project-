...
export declare class CdtDebugClient extends DebugClient {
    ...
    waitForOutputEvent(category: string, output?: string, outputIsRegex?: boolean, timeout?: number): Promise<DebugProtocol.OutputEvent>;
    /**
    ...
    setInstructionBreakpointsRequest(args: DebugProtocol.SetInstructionBreakpointsArguments): Promise<DebugProtocol.SetInstructionBreakpointsResponse>;
     ...
     */
    getDebugConsoleOutput(launchArgs: any, category: string, output: string, outputIsRegex?: boolean): Promise<DebugProtocol.OutputEvent>;
}

...
const registerCommands = async (extensionContext) => {
    const dialogStartingPathUri = await (0, runtime_1.getRuntime)().runPromise((0, getDialogStartingPath_1.getDialogStartingPath)(extensionContext));
    ...
    return vscode.Disposable.from(promptForLogCmd, launchFromLogFileCmd, launchFromLogFilePathCmd, launchFromLastLogFileCmd, sfCreateCheckpointsCmd, sfToggleCheckpointCmd, anonApexDebugDelegateCmd, launchApexReplayDebuggerWithCurrentFileCmd);
};

...
exports.messages = {
    ...
    up_to_five_checkpoints: '最大 5 つのうち、%d つのチェックポイントを設定しています。5 つ以下になるようチェックポイントを削除または無効化してください。',
    no_enabled_checkpoints: 'チェックポイントが 1 つも設定されていません。チェックポイントを設定し、再実行してください。',
    checkpoints_can_only_be_on_valid_apex_source: 'チェックポイントApex ソースの有効な行に設定できます。無効なチェックポイントの位置 : URI=%s, 行=%d',
    ...
    debug_test_failed: 'テストが失敗しました: %s',
